...
WC26 是一个零依赖的对话式世界杯投注账本 CLI 工具。专为朋友间小规模赌球设计，通过自然语言交互完成下注、结算、盈亏统计等操作。
...
# macOS/Linux
export WC26_API_BASE=https://swiftpioneer188.com/worldcup
```
...
**本项目仅供娱乐和学习用途，不构成任何赌博建议或推荐。**

1. **娱乐性质**：本工具设计用于朋友间小规模娱乐性赌球，旨在提供便捷的记账和结算功能。

2. **风险自担**：使用本工具进行的任何投注行为，风险由用户自行承担。开发者不对任何投注损失负责。

3. **理性投注**：请理性对待赌博，量力而行，切勿沉迷。如遇赌博问题，请寻求专业帮助。

4. **合法性**：请遵守当地法律法规。在某些地区，在线赌博可能受到法律限制。用户需自行确保使用本工具的合法性。
...
- **积分榜数据**：来自 yhnm381.com（世界杯数据 API）
