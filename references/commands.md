...
| 命令 | 参数 | 说明 |
|:-----|:-----|:-----|
| `odds` | `[--detail] [--match <id>] [--team <队名>]` | 查看实时赔率 |
| `analytics` | `[--days <天数>] [--type <玩法>]` | 数据分析报告 |
| `sentiment` | `[--team <队名>]` | 社交媒体情绪分析 |
...
| `elo` | `[--match <比赛ID>] [--team <队名>]` | 查看 ELO 球队排名 |
...
| 命令 | 参数 | 说明 |
|:-----|:-----|:-----|
| `hot` | `[--platform <平台>] [--no-auto] [--match <比赛ID>]` | 查看热搜（支持微博/百度/抖音等） |
| `prefer` | `<list\|add\|remove> <队名>` | 管理用户偏好球队 |
